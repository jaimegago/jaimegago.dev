...
{{< figure src="/images/joe-launch/flyball-governor.png" cap="400" alt="An engraved-style illustration of a brass flyball governor on a wooden base" caption=`A centrifugal "flyball" governor — the first machine built to govern a machine. Joe wears it as its mark.` >}}
...
{{< figure src="images/joe-launch/teams-ask-redacted.png" float="right" alt="Teams message asking the platform lead to run kubectl get mutatingwebhookconfigurations on the cluster" caption="The handoff: my theory, and the one command my permissions couldn't run." >}}

He checked. Minutes later: *"you are righ about the mutating webhook!!!!"* (typo his, enthusiasm preserved).

{{< figure src="images/joe-launch/teams-confirmation-redacted.png" float="left" alt="Teams reply confirming the mutating webhook was the culprit" caption="The payoff, verbatim." >}}
